                ...
                <div className="flex items-center gap-3 mb-8 group cursor-pointer">
                    ...
                    <div>
                        <h1 className="text-xl font-bold tracking-tight text-white flex items-center gap-1.5">
                            {t('RoadMaps')} <span className="text-emerald-500">{t('App')}</span>
                        </h1>
                        <p className="text-[10px] font-bold text-zinc-500 uppercase tracking-widest">{t('version') || 'v2.5.0'}</p>
                    </div>
                </div>
                ...
                <nav className="flex-1 space-y-6">
                    <div className="space-y-1">
                        ...
                        <button 
                            ...
                            className={`w-full flex items-center gap-3 px-4 py-3 rounded-xl transition-all ${activeTab === 'analyze' ? 'bg-cyan-500 text-black shadow-lg shadow-cyan-500/20 font-bold' : 'text-zinc-500 hover:text-white hover:bg-white/5 font-medium'}`}
                        >
                            <svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M15 12a3 3 0 11-6 0 3 3 0 016 0z" />
                                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M2.458 12C3.732 7.943 7.523 5 12 5c4.478 0 8.268 2.943 9.542 7-1.274 4.057-5.064 7-9.542 7-4.477 0-8.268-2.943-9.542-7z" />
                            </svg>
                            <span className="text-sm">{t('analyze_chart') || 'Analyze Chart'}</span>
                        </button>
                ...
                <div className="pt-6 border-t border-white/5 mt-auto">
                    <div className="flex items-center justify-center">
                        <a
                            ...
                            className="text-xs font-bold text-zinc-500 hover:text-emerald-500 transition-colors underline decoration-dotted underline-offset-4"
                        >
                            Roadmaps.ir
                        </a>
                    </div>
